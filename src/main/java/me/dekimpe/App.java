...
public class App 
{
    public static void main( String[] args )
    {
        ...
        Dataset<Row> joined = pagelinks.join(revisions, pagelinks.col("id").equalTo(revisions.col("id")), "left_outer").where((pagelinks.col("title").equalTo(subject)).or(revisions.col("title").equalTo(subject))).cache();
